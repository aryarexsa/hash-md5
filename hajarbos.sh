...
figlet hash-md5 | lolcat

echo -e "\e[1;77m --------------------------------------" | lolcat
echo -e "\e[1;92m #  Tipe Tools      : md5 hash        #" 
echo -e "\e[1;92m #  Team            : TazManianDevil  #" 
echo -e "\e[1;36m #  Code By         : DemonX          #" 
echo -e "\e[1;31m #  Tanggal Dibuat  : 06/29/2020      #" 
echo -e "\E[35m --------------------------------------" 
sleep 1
...
printf "\n\e[1;77m[\e[0m\e[1;92m+\e[0m\e[1;77m]\e[0m \e[1;92mCode By DemonX\e[0m\n"

printf "\n\e[1;77m[\e[0m\e[1;93m+\e[0m\e[1;77m]\e[0m \e[1;93mPetunjuk penggunaan:\e[0m\e[1;77m bash hajarbos.sh\e[0m\n\n"
else
